...
| `make-cover.mjs` | 正确封面通路:生成带英文标题的主题化封面候选,自动注入角色圣经;首选 `COVER_MODE=story` | `BOOK_ID=xxx TITLE="Duck Dance Day" CHARS=shuishui,papa COVER_MODE=story STORY_THEME="..." SCENE="..." N=3 node scripts/make-cover.mjs` → 产物落 `experiments/<date>/<book>-cover/` |
