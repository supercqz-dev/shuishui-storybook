...
// 注意:绝对不要写"爸爸/妈妈/姥姥/X岁/幼儿/宝宝/老太太"等家庭称谓或精确年龄——
// 这些是故事层设定,跟画面无关,却是 Azure 安全分类器触发"成人+幼儿"模板的强信号。
// 视觉成熟度只用形态词表达:幼态比例 / 年轻挺拔 / 年长慈祥卷白毛 等。
const characters = [
  {
    id: 'shuishui',
    prompt: `可爱的拟人化白色小兔子,采用高级动画电影级CGI风格,大头小身的幼态比例(头占身高约一半,头身比 1:2),纯白色蓬松柔软的绒毛,长长的兔耳朵竖立向上(比头还高),圆圆肉肉的脸庞和软软的肥脸颊,大大明亮的琥珀色眼睛,粉色的小鼻子,甜美温暖的微笑,身着粉色小裙子,粉色小运动鞋,头顶戴着粉色碎花发带(发带前侧别着一颗粉色爱心发卡,发卡在发带上不在耳朵上),活泼好奇,姿态自然放松,全身角色设计,电影级柔和的光照,鲜艳而自然的色彩,富有表现力的面部表情,优雅可爱,自然乖巧.`
  },
  {
    id: 'papa',
    prompt: `可爱的拟人化年轻红狐狸,采用高级动画电影级CGI风格,瘦高匀称挺拔的身材,温暖的红橙色毛发(腹部和脸下侧奶白色),三角形竖耳尖端深色,蓬松的大狐狸尾巴尖端白色,温暖的绿色眼睛,戴着细边棕色玳瑁色眼镜(细金属/醋酸纤维框),友好开朗的笑容,身着白色T恤+深绿色褶皱设计师外套+深蓝色褶皱长裤+深灰色翻毛皮运动鞋,左手腕戴着银珠子手链,设计师感利落质感的气质,姿态自然放松挺拔,全身角色设计,电影级柔和的光照,鲜艳而自然的色彩,富有表现力的面部表情,优雅可爱.`
  },
  {
    id: 'laolao',
    prompt: `可爱的拟人化年长绵羊,采用高级动画电影级CGI风格,微胖慈祥的体型,头顶卷毛打理整齐(纯白色卷毛,雪白不偏黄,不松散凌乱),柔软的绵羊耳朵软软地垂在脸两侧,笑起来眯眯眼,慈祥但精气神十足,不戴任何眼镜(脸上没有眼镜),身着白色亚麻衬衫+浅棕色棉麻宽松裤+暖灰色穆勒鞋,时髦但不刻意的气质,姿态自然放松慈祥,全身角色设计,电影级柔和的光照,鲜艳而自然的色彩,富有表现力的面部表情,优雅可爱.`
  }
];
